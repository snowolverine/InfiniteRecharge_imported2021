...
public class AutoLoadBall extends Command {
  ...
  public AutoLoadBall(double x, double y, double z) {
    length = z;
    rightLength = x;  
    leftLength = y;
  ...
  protected void execute() {
    ...
    Robot.elevator.setLiftMotor1(-leftLength);
    Robot.elevator.setLiftMotor2(rightLength);
