...
public class RobotMap {
  ...
  public static final double MAX_SPEED_LIFT1 = .6; //0-1 max speed
  public static final double MAX_SPEED_LIFT2 = .6; //0-1 max speed
  public static final double MAX_SPEED_GRAB = .6; //0-1 max speed
  public static final double MAX_SPEED_TURRET = .6; //0-1 max speed
  public static final double MAX_SPEED_SHOOT = .80; //0-1 max speed
